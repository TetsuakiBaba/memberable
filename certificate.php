...
<body>
    ...
    <div class="container-certificate">
        <div class="certificate">
            <!-- シール画像 -->
            <div class="seal">
                <img src="./images/ADADA.png" width="200px" alt="Seal">
            </div>
            <h1 style="margin-top:20%; margin-bottom:2rem;">Certificate of Membership</h1>
            ...
            <div class="date">
                <p style="font-size:0.7rem;">Date Issued: <?php echo date('F j, Y');  ?> </p>

            </div>

            <div class="signature">
                <img src="./images/kakuin.png" alt="Signature">
            </div>
        </div>
    </div>
